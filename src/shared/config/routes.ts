export const ROUTES = {
  ...
  ADMIN_DELIVERY_PICKUP_POINTS: "/admin/delivery/pickup-points",
  ADMIN_DELIVERY_SETTINGS: "/admin/delivery/settings",
  ...
  ADMIN_ORDERS_ASSEMBLY: "/admin/orders/assembly",
  ADMIN_ORDERS_COURIER: "/admin/orders/courier",
