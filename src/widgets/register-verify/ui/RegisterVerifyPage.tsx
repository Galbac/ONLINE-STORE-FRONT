...
import { VerifyOtpForm } from "@/features/verify-register-otp";
import { ROUTES } from "@/shared/config";
import { Container } from "@/shared/ui";
import { Footer } from "@/widgets/footer";
import { Header } from "@/widgets/header";
import { ShieldCheck, MailCheck, Clock } from "lucide-react";
      ...
      <main className="min-h-[75vh] py-10 bg-gradient-to-b from-slate-50 to-white">
        <Container className="max-w-4xl">
          <nav className="text-slate-400 mb-8 flex items-center gap-2 text-xs font-semibold">
            ...
            <span>/</span>
            <Link className="hover:text-emerald-700 transition" href={ROUTES.REGISTER}>
              Регистрация
            </Link>
            <span>/</span>
            <span className="text-slate-700">Подтверждение кода</span>
          </nav>
          ...
          <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-start">
            ...
            <aside className="rounded-3xl border border-emerald-100 bg-gradient-to-br from-emerald-50/70 via-teal-50/40 to-slate-50/30 p-8 shadow-xs space-y-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-base font-bold text-slate-900">Безопасность аккаунта</h2>
                  <p className="text-xs text-slate-500">Защита от спама и взлома</p>
                </div>
              </div>
              ...
              <div className="space-y-4 pt-2">
                <div className="flex items-start gap-3.5">
                  ...
                  <div>
                    <p className="text-xs font-bold text-slate-800">Проверьте входящие</p>
                    <p className="text-[11px] text-slate-500 mt-0.5 leading-relaxed">
                      Письмо отправлено мгновенно. Если во входящих пусто, проверьте папку «Спам» или «Рассылки».
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3.5">
                  ...
                  <div>
                    <p className="text-xs font-bold text-slate-800">Срок действия кода</p>
                    <p className="text-[11px] text-slate-500 mt-0.5 leading-relaxed">
                      Код действителен в течение 10 минут. После этого можно запросить новый.
                    </p>
                  </div>
                </div>
              </div>
