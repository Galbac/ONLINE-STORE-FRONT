...
const sections: LegalSection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      `Обращения по возврату денежных средств и претензии по качеству принимаются по телефону ${STORE_INFO.phone} и на email ${STORE_INFO.email} в течение 24 часов с момента получения заказа.`,
    ],
  },
];
