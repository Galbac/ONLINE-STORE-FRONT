...
export const API_ENDPOINTS = {
  ...
  ADMIN: {
    ...
    NOTIFICATION_SETTINGS: "/api/admin/notifications/settings",
    NOTIFICATION_TEST_EMAIL: "/api/admin/notifications/test-email",
    NOTIFICATION_TEST_TELEGRAM: "/api/admin/notifications/test-telegram",
